...
public class CartResources {
    ...
    /*public void addItem (@PathVariable(value = "productId") int productId, @AuthenticationPrincipal Customer activecustomer){
        Customer customer = customerService.getCustomerByCustomerName(activecustomer.getCustomerName());*/
